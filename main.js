...
/* harmony import */ var _components_cats_cats_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./components/cats/cats.component */ "./src/app/components/cats/cats.component.ts");
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            declarations: [
                ...
                _components_cats_cats_component__WEBPACK_IMPORTED_MODULE_5__["CatsComponent"],
...
module.exports = "<h1>Cat Sets</h1>\n<ul>\n  <div *ngFor=\"let set of catSets\"\n       (click)=\"onSelect(set)\">\n    <h2>{{set.name}}</h2>\n    <div *ngIf=\"selectedSet && selectedSet === set\">\n      <h3>Ubers</h3>\n      <div *ngFor=\"let uber of set.uberRareCats; let i = index\">\n        {{i}}: {{uber.name}}\n      </div>\n    </div>\n  </div>\n</ul>\n"
